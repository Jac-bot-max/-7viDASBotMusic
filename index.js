...
async function startBot() {
    // =========================================================================
    // REGIÃO 2: ANTI-BAN & RECUPERAÇÃO DE SESSÃO
    // =========================================================================
    ...
    // =========================================================================
    // REGIÃO 3: BOAS-VINDAS POR CARGO (FOTO + REGRAS)
    // =========================================================================
    ...
    socket.ev.on("messages.upsert", async (m) => {
        try {
            ...
            // =====================================================================
            // REGIÃO 6: AUTO-RESPONDER SOCIAL (RESPEITO)
            // =====================================================================
            ...
            // =====================================================================
            // REGIÃO 7: COMANDOS MANUAIS (PESQUISAS, INFO & GESTÃO)
            // =====================================================================
            ...
            const avisoBusca = async () => await socket.sendMessage(from, { text: "🔍 _Procurando, aguarde..._" });
            ...
            switch (command) {
                ...
                case "promover":
                    if (isSenderAdmin && isBotAdmin && target) await socket.groupParticipantsUpdate(from, [target], "promote");
                    break;

                case "rebaixar":
                    if (isSenderAdmin && isBotAdmin && target) await socket.groupParticipantsUpdate(from, [target], "demote");
                    break;

                case "ban":
                    if (isSenderAdmin && isBotAdmin && target) await socket.groupParticipantsUpdate(from, [target], "remove");
                    break;
